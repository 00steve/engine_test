...
#ifndef INDUITEXTBOX_H
#define INDUITEXTBOX_H
#include "induiwidget.h"
#include "../graphics/glvectortext.h"

class IndUITextBox : public IndUIWidget
{
    private:
        ...
        void CutSelected() {
            ...
            //modify the string reference
            //cout << kbt << endl;
            //if any chars are selected, remove them from the string
    ...
    IndUITextBox(string name,string* &text) {
        this->name = name;
        this->text = text;
